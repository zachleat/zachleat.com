...
if( !empty( $referrer ) ) {
?>
	<p>It’s likely you’ve been redirected to this page by an improper use of <code>target="_blank"</code>. Nothing malicious has occurred here. This page is only intended to spread the word about the consequences of using <code>target="_blank"</code>. <a href="https://mathiasbynens.github.io/rel-noopener/"><strong>Learn more from Mathias Bynens.</strong></a></p>
