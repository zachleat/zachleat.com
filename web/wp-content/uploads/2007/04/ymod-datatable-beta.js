...
YAHOO.widget.DataTable.prototype._lastSelectedId = null; // ADDED
...
YAHOO.widget.DataTable.prototype._initTable = function() {
	...
	// ADDED BLOCK
	var scrollingDiv = this._elContainer.appendChild(document.createElement('div'));
	if(this.scrollable) {
        YAHOO.util.Dom.addClass(scrollingDiv,'ymod-scrollingHeader');
    }
    this._elHeaderTable = scrollingDiv.appendChild(document.createElement("table")); // CHANGED
	this._elHeaderTable.className = YAHOO.widget.DataTable.CLASS_TABLE;
	YAHOO.util.Event.addListener(this._elHeaderTable, "click", this._onClick, this);
    YAHOO.util.Event.addListener(this._elHeaderTable, "dblclick", this._onDoubleclick, this);
    YAHOO.util.Event.addListener(this._elHeaderTable, "mouseout", this._onMouseout, this);
    YAHOO.util.Event.addListener(this._elHeaderTable, "mouseover", this._onMouseover, this);
    YAHOO.util.Event.addListener(this._elHeaderTable, "mousedown", this._onMousedown, this);
    //YAHOO.util.Event.addListener(this._elHeaderTable, "mouseup", this._onMouseup, this);
    //YAHOO.util.Event.addListener(this._elHeaderTable, "mousemove", this._onMousemove, this);
    YAHOO.util.Event.addListener(this._elHeaderTable, "keydown", this._onKeydown, this);
    YAHOO.util.Event.addListener(this._elHeaderTable, "keypress", this._onKeypress, this);
    YAHOO.util.Event.addListener(this._elHeaderTable, "keyup", this._onKeyup, this);
    //YAHOO.util.Event.addListener(this._elHeaderTable, "focus", this._onFocus, this);
    YAHOO.util.Event.addListener(this._elHeaderTable, "blur", this._onBlur, this);
	// END ADDED BLOCK

    // Create TABLE
	var scrollingDiv = this._elContainer.appendChild(document.createElement('div')); //ADDED
	if(this.scrollable) {
        YAHOO.util.Dom.addClass(scrollingDiv,'ymod-scrollingBody');
    } // ADDED
	YAHOO.util.Event.addListener( scrollingDiv, 'scroll', function(e, obj) {
		// obj is this._elHeaderTable parentnode, scrollingDiv
		obj.scrollLeft = this.scrollLeft;
	}, this._elHeaderTable.parentNode ); // ADDED
    this._elTable = scrollingDiv.appendChild(document.createElement("table")); // CHANGED
   ...
   // this._initHead(elTable, this._oColumnSet);
    this._initHead(this._elHeaderTable, this._oColumnSet); //ADDED
...
YAHOO.widget.DataTable.prototype._initHead = function() {
    ...
    this._elHead = this._elHeaderTable.appendChild(elHead); //ADDED
...
YAHOO.widget.DataTable.prototype._initHeadCell = function(elHeadCell,oColumn,row,col) {
	...
	if( oColumn.getRowSpan() > 1 || oColumn.getColSpan() > 1 ) 
	{
		YAHOO.util.Dom.addClass( this._elHeaderTable.parentNode, 'ymod-nestedHeaders' );
	} // ADDED
...
YAHOO.util.WidthResizer.prototype.onDrag = function(e) {
	...
	var columnIndex = parseInt( elCell.getAttribute( 'id' ).substr( elCell.getAttribute( 'id' ).indexOf( 'col' ) + 3 ), 10 ); // ADDED
	// first the tbody, then the tr.
	var firstRowColumn = oDataTable._elTable.childNodes[ 1 ].childNodes[ 0 ].childNodes[ columnIndex ];
	//console.log( oDataTable, oDataTable._elTable, firstRowColumn );
	firstRowColumn.style.width = newWidth + 'px ! important'; // ADDED
};
