...
![](/web/wp-content/uploads/2011/02/Screen-shot-2011-02-21-at-10.15.44-AM.png)
...
{% renderTemplate "webc" %}<div><youtube-lite-player @slug="YuRuYdfvTA0" :@label="$data.title"></youtube-lite-player></div>{%- endrenderTemplate %}
