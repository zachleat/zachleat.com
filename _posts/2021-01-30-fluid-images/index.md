...
---
A few days back [{% twitterImageAvatar "CarolSaysThings" %}CarolSaysThings](https://twitter.com/carolsaysthings) posed what I expected to be a simple question until I started to question what I already knew. Carol had some image markup (generated by [Eleventy Image](https://www.11ty.dev/docs/plugins/image/#use-this-in-your-templates)) and was asking the best way to make the image fluid (match the width of its container). I knew I understood this well enough to use it in my own work but I started to realize that perhaps I _didn’t_ know this topic well enough to **teach** it so I dove in a little deeper.
