...
~~For bonus metadata, here’s one with a Lighthouse score attached ([updated regularly via Speedlify](https://www.speedlify.dev/group/zachleat/)), a webmentions count, and even the page weight (e.g. 226 KiB, also driven by Speedlify)~~ _(I removed this feature at some point for simplicity)_
