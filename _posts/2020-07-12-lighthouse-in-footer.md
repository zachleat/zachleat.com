...
<div class="primarylink"><a href="https://www.speedlify.dev/group/zachleat/">Speedlify for zachleat.com</a> (link updated to speedlify2)</div>
...
2. Consume the Speedlify API data files—they are generated automatically with your Speedlify instance.
	* Use [Eleventy’s Cache Assets plugin](https://github.com/11ty/eleventy-cache-assets): `npm install @11ty/eleventy-cache-assets --save-dev` (Updated 2026: now `@11ty/eleventy-fetch`)
...
3. Use the [`<speedlify-score>` Web Component](https://github.com/zachleat/speedlify-score/). (_These instructions were updated July 17, 2020_)
	...
	* Also set the `speedlify-url` attribute to point to your Speedlify instance. Mine is `speedlify-url="https://www.speedlify.dev"`
