...
tags:
  - eleventy
  - project
githubProjectName: 11ty/api-screenshot
---
<style>
.screenshot {
...
1. _Update (July 30, 2021):_ The other issue I noticed with using Puppeteer in a Lambda is that emoji are not available to the rendered content. So if a site is using Emoji they do not render. It looks like [Matic Jurglič may have a workaround to solve this](https://jurgen.si/posts/lambda-headless-chrome-emojis/).
