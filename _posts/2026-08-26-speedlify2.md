...
---
<a href="https://www.speedlify.dev/"><img src="./2026-08-26-speedlify2.png" alt="Speedlify2 screenshot" eleventy:widths="1000"></a>
...
- This also shows screenshots for No-JavaScript and JavaScript-enabled, reporting the visual percentage difference between the two. This is not feeding into rankings (as it isn’t a foolproof measure) but it has utility and can easily reveal sites that use client side rendering ([`solidjs.com` at ∆ 77.4%](https://www.speedlify.dev/site/www-solidjs-com/#without-javascript)), sites that may have bugs in their dark/light mode switcher ([`nuxt.com` at ∆ 99.8%](https://www.speedlify.dev/site/nuxt-com/#without-javascript)), or sites that use an announcement bar that causes the entire page to layout shift ([`svelte.dev` at ∆ 36.2%](https://www.speedlify.dev/site/svelte-dev/#without-javascript)).
