...
githubProjectName: zachleat/speedlify2
tags: project
---
<a href="https://www.speedlify.dev/"><img src="./speedlify2/speedlify2.png" alt="Speedlify2 screenshot" eleventy:widths="1000"></a>
...
- Everything is static and self contained, deployable via GitHub Actions to GitHub Pages. You can [easily deploy your own Speedlify2](https://github.com/zachleat/speedlify2/). _(Run the reset script to start from scratch)_
...
It might be interesting to look at the report of [Speedlify measuring Speedlify](https://www.speedlify.dev/site/www-speedlify-dev/), which includes measurements before the production domain was moved from Speedlify (classic) to Speedlify2. We can see how the migration went!
...
Specifically, it can reveal sites that exclusively use client side rendering ([`solidjs.com` at ∆ 77.4%](https://www.speedlify.dev/site/www-solidjs-com/#without-javascript)):

<a href="https://www.speedlify.dev/site/www-solidjs-com/#without-javascript"><img src="./speedlify2/solidjs.png" alt="With and without JavaScript, the left panel is completely white" eleventy:widths="1000"></a>

It can reveal sites that may have bugs in their dark/light mode switcher ([`nuxt.com` at ∆ 99.8%](https://www.speedlify.dev/site/nuxt-com/#without-javascript)):

<a href="https://www.speedlify.dev/site/nuxt-com/#without-javascript"><img src="./speedlify2/nuxt.png" alt="With and without JavaScript, the left panel is light themed and the right panel is dark themed" eleventy:widths="1000"></a>

It can reveal sites that use an announcement bar that causes the entire page to layout shift ([`svelte.dev` at ∆ 36.2%](https://www.speedlify.dev/site/svelte-dev/#without-javascript)):

<a href="https://www.speedlify.dev/site/svelte-dev/#without-javascript"><img src="./speedlify2/svelte.png" alt="With and without JavaScript, the right panel has an announcement bar and the content has shifted down" eleventy:widths="1000"></a>

## Highlighting Good Sites

The [Built Awesome Leaderboards](https://www.speedlify.dev/group/11ty-community/) are intended to be a very rigorous and competitive leaderboard. The sites that score well here are _very_ fast.
