...
* Go directly to [Font Family Reunion](https://fontfamily.zachleat.dev) (do not pass go, do not collect $200).
* Read the [Blog Post](/web/font-family-reunion/).
* Watch the NebraskaJS recap: [How and Why I built Font Family Reunion](https://web.archive.org/web/20240518010357/http://nebraskajs.com/2015/fontfamilyio/)

{% renderTemplate "webc" %}<div><youtube-lite-player @slug="LbCT38Idhyk"></youtube-lite-player></div>{%- endrenderTemplate %}
...
{% renderTemplate "webc" %}<div><youtube-lite-player @slug="1EL4VpScnxE"></youtube-lite-player></div>{%- endrenderTemplate %}
...
{% renderTemplate "webc" %}<div><youtube-lite-player @slug="6nGxIBMMaFw"></youtube-lite-player></div>{%- endrenderTemplate %}
