...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		shell: {
			...
			upload: {
				command: 'echo "Note: Requires an \'zachleat-test2\' host in .ssh/config"; rsync --archive --verbose --stats --compress --rsh=ssh ./_site/ zachleat-test2:/home/public/<%= config.root %>',
				options: {
