...
YAHOO.widget.DataTable.prototype._initTableEl = function() {
	...
	this._elContainer.appendChild(scrollingDiv);
	if(this._oConfigs.scrollable) {
        YAHOO.util.Dom.addClass(scrollingDiv,'ymod-scrollingHeader');
    }
    this._elHeaderTable = scrollingDiv.appendChild(document.createElement("table"));
	...
	}, this._elHeaderTable.parentNode );
	// ymod END ADDED BLOCK

    // Create TABLE
    //this._elTable = this._elContainer.appendChild(document.createElement("table"));
	this._elTable = scrollingDiv.appendChild(document.createElement("table")); // ymod CHANGED
    ...
    this._initTheadEl(this._elHeaderTable, this._oColumnSet); // ymod CHANGED
	...
	// ymod MOVED (was above Create TBODY for data)
...
YAHOO.widget.DataTable.prototype._initTheadEl = function() {
    ...
    this._elThead = this._elHeaderTable.appendChild(elThead); // ymod CHANGED
